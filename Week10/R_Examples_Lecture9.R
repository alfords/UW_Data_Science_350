...
setwd('/Users/voitel/TRAINING/UW_Data_Science/UW_Data_Science_350/Week10')
...
# Warning, a new package of stringdist was uploaded days ago,
#  and the new version number may not be updated in the
#  CRAN repository.
library(stringdist)
...
hist(sample_distances_weighted, breaks=35)
